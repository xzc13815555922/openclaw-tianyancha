...
BUILDING_RULES = [
    # 盐南高新区 20栋
    ("金融城", ["金融城", "世纪大道5号"]),
    ("大数据产业园", ["大数据产业园", "创新大厦", "学海路29号"]),  # 排除张庄、盐龙
    ("新龙广场", ["新龙广场", "新弄里", "人民南路38号"]),
    ("华邦国际", ["华邦国际", "华邦东厦", "华邦西厦"]),
    ("紫薇广场", ["紫薇广场", "人民南路2号"]),
    ("金鹰天地", ["金鹰龙湖商业广场", "金鹰聚龙湖购物中心"]),
    ("钱江财富广场", ["钱江商业街", "钱江财富广场"]),
    ("西伏河园区", ["西伏河", "文港南路49号", "文港南路77号", "新园路52号"]),
    ("国际创投中心", ["国际创投中心", "人民南路5号"]),
    ("凤凰文化广场", ["凤凰文化广场", "世纪大道611号"]),
    ("财富港", ["依云小镇商城", "财富港9号楼"]),
    ("中信大厦", ["中信大厦", "迎宾南路188号"]),
    ("中远商务楼", ["开放大道10号", "中远商务楼"]),
    ("新都社区商务楼", ["新都社区商务楼", "新都商务楼", "人民南路33号"]),
    ("鹿鸣广场", ["鹿鸣广场", "人民中路5号"]),
    ("香城美地", ["香城美地"]),
    ("棕榈泉", ["棕榈泉广场"]),
    ("丽晶大厦", ["丽晶大厦", "解放南路198号丽晶"]),
    ("南海流量经济港", ["南海流量经济港"]),
    ("伍佑新型显示产业园", ["伍佑新型显示产业园", "伍佑街道构港村"]),
    # 经开区 7栋
    ("未来科技城", ["未来科技城", "希望大道南路5号"]),
    ("全民创业园（步凤）", ["全民创业园", "全创路", "步凤镇头灶村全民创业园"], "street=步凤镇"),
    ("涌鑫经贸中心", ["涌鑫中心", "涌鑫经贸中心", "新都东路31号"]),
    ("韩资工业园", ["韩资工业园", "希望大道南路1号", "黄山南路65号"]),
    ("光电产业园", ["新能源汽车产业园", "黄山南路38号"]),
    ("新能源汽车产业园", ["光电产业园", "希望大道南路15号", "五台山路97号"]),
    ("盐城综合保税区", ["盐城综合保税区"]),
]
...
def extract_small_building(addr, building):
    ...
    # 中信大厦/鹿鸣广场/中远商务楼 - 单楼宇
    if building in ("中信大厦", "鹿鸣广场", "中远商务楼"):
        return building
